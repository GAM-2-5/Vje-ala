...
#uvod u igru
    ...
    while pokretanje:    #pokretanje potlje
        riječi=['adresa','aerodrom','akt','alat','aluminij','amper','anđeo','anatomija','argument','arheologija','arhiva','aplauz','ateist','atlas','autobiografija','avion','avokado','bajka','bakar','barka','bakterija','balet','banka','bara','bazen','bedro','bejzbol','bicikl','bilježnica','biser','biro','bitka','bivol','bojica','bojler','bol','bombon','bor','briga','bijes','bubanj','car','cesta','cigla','cilj','cjepivo','crkva','crtež','cvijet','duh','dan','daska','dvorac','dijete','dim','disk','dodatak','događaj','dostava','ekologija','eksperiment', 'esej','evolucija',
